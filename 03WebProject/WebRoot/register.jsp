...
<script type="text/javascript" src="static/js/jquery.validate.js" charset="gb2312"></script>
<script type="text/javascript" src="static/js/messages_cn.js" charset="gb2312"></script>
    <script src="http://cdn.bootcss.com/amazeui/2.7.2/js/amazeui.min.js"></script>
    <script src="static/js/theme.js"></script>
    <script src="static/js/app.js"></script>
    <!--自己的js-->
<script type="text/javascript" src="static/js/bootstrap.js"></script>
<script type="text/javascript" src="static/js/myjs/register.js" charset="gb2312"></script>
